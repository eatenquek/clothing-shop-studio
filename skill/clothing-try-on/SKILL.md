...
description: Use only when the user explicitly invokes $clothing-try-on to put an owned approved design on a fictional presentation model.
---
...
- `try_on` with modes `plan`, `register`, `decide`

## Core references

- `references/presentation.md` — “Try-on”
...
- Refuse shopper try-on and third-party branded garments; use approved owned designs and fictional models only.
