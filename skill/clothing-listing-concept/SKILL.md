...
description: Use only when the user explicitly invokes $clothing-listing-concept to create a non-live marketplace-style visual for their approved garment.
---
...
- `create_listing` with modes `build`, `decide`

## Core references

- `references/presentation.md` — “Listing concept”
...
- Create a labelled non-live concept with no prices, sizes, unconfirmed claims, or publishing.
