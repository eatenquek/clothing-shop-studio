...
description: Use only when the user explicitly invokes $clothing-ai-models to create or manage fictional presentation models for their garments.
---
...
- `create_models` with modes `install_defaults`, `plan`, `plan_reference`, `register`, `keep`

## Core references

- `references/presentation.md` — “AI models”
...
- Keep decisions require the user's own affirmative reply.

## Scope boundaries

- Create fictional people only; refuse real people, celebrities, influencers, and lookalikes.
